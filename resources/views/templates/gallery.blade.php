...
<!-- PAGE TITLE
    ...
    <div class="container">
        <!-- Nav -->
        <ul class="nav justify-content-center course-tab-v1 border-bottom h4 mb-8 d-none">
            <li class="nav-item">
        ...
        <div id="gallery" class="row row-cols-md-3 mb-8 mb-md-11" data-isotope='{"layoutMode": "masonry"}'>
            ...
            <div class="col-md mb-6 business">
                <!-- Image -->
                <a class="card-hover-overlay rounded overflow-hidden d-block position-relative" href="{{ url('/storage/gallery/images/' . $gal->gallery_image_name) }}" data-fancybox data-width="1110" data-height="810">
                    <img src="{{ url('/storage/gallery/images/'.$gal->gallery_image_name) }}" class="img-fluid rounded" alt="...">
