...
<head>
    ...
    <script type="text/javascript">
        window.APP_URL = window.location.hostname
    </script>
    <!-- Favicon -->
...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="collapse show" id="collapseSignin" data-bs-parent="#accountModal">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="mb-0 font-size-sm text-center">
                            Don't have an account? <a class="text-underline" href="{{url('teacher_reg')}}"">Teacher Sign up</a>
                        </p>
                    </div>
                </div>
    ...
    <!-- NAVBAR
    ================================================== -->
    <div class="container d-none d-xl-block bg-theme-1">
        <div class="d-flex align-items-center border-bottom border-white-20 pt-2 pb-4">
            <ul class="nav mx-n3">
                <li class="nav-item px-3">
                    <span class="font-size-sm text-white">+91 123456789</span>
                </li>
                <li class="nav-item px-3">
                    <span class="font-size-sm text-white">support@einix.com</span>
                </li>
            </ul>
        ...
        <div class="container">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link pb-4 mb-n4 px-0 pt-0" id="navbarVerticalMenu" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                        <div class="bg-white-10 rounded-xl py-3 px-5 d-flex align-items-center">
                            <span class="text-white fw-medium me-1">Classess</span>
            ...
            <div class="collapse navbar-collapse z-index-lg" id="navbarCollapse">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <a href="{{route('index')}}/pages/about_us">
                        <li class="nav-item nav-link">About us</li>
                    </a>
                    <a href="{{route('index')}}/pages/contact_us">
                        <li class="nav-item nav-link">Contact</li>
                    </a>
                    <a href="{{route('index')}}/gallery">
                        <li class="nav-item nav-link">Gallery</li>
                    </a>
                </ul>
            </div>
    ...
    <!-- FOOTER
    ================================================== -->
    <footer class="pt-8 pt-md-13 pt-xl-15 position-relative bg-theme-1">
        <!-- Shape -->
