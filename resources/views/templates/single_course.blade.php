...
@section('content')
  <!-- PAGE HEADER
    ================================================== -->
    <div class="position-relative pt-8 pt-xl-11 pt-11">
        <div class="position-absolute top-0 right-0 left-0 overlay overlay-custom-left d-xl-block">
        ...
        <div class="row mb-8">
            <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                <div class="course-single-white">
                    ...
                    <p class="me-xl-13 mb-5 text-white">Master Figma app to get a job in UI Design, User Interface, User Experience design, Web Design & UX design.</p>
                ...
                <div class="d-md-flex align-items-center mb-5 course-single-white">
                    <div class="border rounded-circle d-inline-block mb-4 mb-md-0 me-md-6 me-lg-4 me-xl-6 bg-white">
                        <div class="p-2">
                            <img src="{{asset('assets')}}/img/avatars/avatar-1.jpg" alt="..." class="rounded-circle" width="68" height="68">
                        </div>
                    </div>
                ...
                <ul id="pills-tab" class="nav course-tab-v1 border-bottom h4 my-8 pt-1" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="pills-instructor-tab" data-bs-toggle="pill" href="#pills-instructor" role="tab" aria-controls="pills-instructor" aria-selected="false">About the instructor</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="media mb-6 d-flex">
                                <a href="course-single-v5.html" class="w-100p d-block me-5">
                                    <img src="{{asset('assets')}}/img/photos/photo-1.jpg" alt="..." class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                            ...
                            <li class="media mb-6 d-flex">
                                <a href="course-single-v5.html" class="w-100p d-block me-5">
                                    <img src="{{asset('assets')}}/img/photos/photo-2.jpg" alt="..." class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                                    <a href="course-single-v5.html" class="d-block">
                            ...
                            <li class="media mb-6 d-flex">
                                <a href="course-single-v5.html" class="w-100p d-block me-5">
                                    <img src="{{asset('assets')}}/img/photos/photo-14.jpg" alt="..." class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                                    <a href="course-single-v5.html" class="d-block">
                            ...
                            <li class="media mb-6 d-flex">
                                <a href="course-single-v5.html" class="w-100p d-block me-5">
                                    <img src="{{asset('assets')}}/img/photos/photo-16.jpg" alt="..." class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                                    <a href="course-single-v5.html" class="d-block">
        ...
        <div class="mx-n4 mb-12" data-flickity='{"pageDots": true, "prevNextButtons": false, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-11.jpg" alt="...">
                        </a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-10.jpg" alt="...">
                        </a>
