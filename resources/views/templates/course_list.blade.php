...
<!-- PAGE TITLE
    ...
    <header class="py-8 py-md-11 bg" style="background-image: none;">
        <div class="container text-center py-xl-2">
            <h1 class="display-4 fw-semi-bold mb-0">Our Core Courses</h1>
    ...
    <section class="pt-5 pb-9 py-md-11 bg-white mb-8 border-bottom">
        <div class="container">
            ...
            <div class="mx-n3 mx-md-n4" data-flickity='{"pageDots": true, "prevNextButtons": false, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
                    ...
                    <div class="card border shadow p-2 lift sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-15.jpg" alt="...">
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 py-5 px-3 px-md-4" data-aos="fade-up" data-aos-delay="100">
                    <!-- Card -->
                    <div class="card border shadow p-2 lift sk-fade">
                        <!-- Image -->
                        <div class="card-zoom position-relative">
                            <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-14.jpg" alt="...">
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 py-5 px-3 px-md-4" data-aos="fade-up" data-aos-delay="150">
                    <!-- Card -->
                    <div class="card border shadow p-2 lift sk-fade">
                        <!-- Image -->
                        <div class="card-zoom position-relative">
                            <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-16.jpg" alt="...">
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 py-5 px-3 px-md-4" data-aos="fade-up" data-aos-delay="200">
                    <!-- Card -->
                    <div class="card border shadow p-2 lift sk-fade">
                        <!-- Image -->
                        <div class="card-zoom position-relative">
                            <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-12.jpg" alt="...">
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 py-5 px-3 px-md-4" data-aos="fade-up" data-aos-delay="250">
                    <!-- Card -->
                    <div class="card border shadow p-2 lift sk-fade">
                        <!-- Image -->
                        <div class="card-zoom position-relative">
                            <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-13.jpg" alt="...">
                            </a>
                ...
                <div class="border rounded-lg px-6 pt-6 bg-white">
                    ...
                    <div class="card sk-fade flex-md-row mb-6 align-items-center row gx-0">
                        ...
                        <div class="col-md-4 card-zoom position-relative">
                            ...
                            <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-2 d-block">
                                <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-15.jpg" alt="...">
                            </a>
                        ...
                        <div class="col-md-8 card-footer px-2 px-md-5 py-4 py-md-0 position-relative">
                            ...
                            <!-- Heading -->
                            <div class="position-relative">
                                <a href="course-single-v5.html" class="d-block stretched-link"><h4 class="line-clamp-2 me-md-6 me-lg-10 me-xl-4 mb-3">The Complete JavaScript Course 2020: Build Real Projects!</h4></a>
                    ...
                    <div class="card sk-fade flex-md-row mb-6 align-items-center row gx-0">
                        ...
                        <div class="col-md-8 card-footer px-2 px-md-5 py-4 py-md-0 position-relative">
                            ...
                            <!-- Heading -->
                            <div class="position-relative">
                                <a href="course-single-v5.html" class="d-block stretched-link"><h4 class="line-clamp-2 me-md-6 me-lg-10 me-xl-4 mb-3">Learn Figma: User Interface Design Essentials - UI/UX Design</h4></a>
                                <ul class="nav mx-n3 mb-3">
                                    <li class="nav-item px-3">
                                        <div class="d-flex align-items-center">
                                            <div class="me-2 d-flex text-secondary icon-uxs">
                    ...
                    <div class="card sk-fade flex-md-row mb-6 align-items-center row gx-0">
                        ...
                        <div class="col-md-4 card-zoom position-relative">
                            ...
                            <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-2 d-block">
                                <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-23.jpg" alt="...">
                            </a>
                        ...
                        <div class="col-md-8 card-footer px-2 px-md-5 py-4 py-md-0 position-relative">
                            ...
                            <!-- Heading -->
                            <div class="position-relative">
                                <a href="course-single-v5.html" class="d-block stretched-link"><h4 class="line-clamp-2 me-md-6 me-lg-10 me-xl-4 mb-3">Guide to Front-End Web Development and Design</h4></a>
                                <ul class="nav mx-n3 mb-3">
                                    <li class="nav-item px-3">
                                        <div class="d-flex align-items-center">
                                            <div class="me-2 d-flex text-secondary icon-uxs">
                    ...
                    <div class="card sk-fade flex-md-row mb-6 align-items-center row gx-0">
                        ...
                        <div class="col-md-4 card-zoom position-relative">
                            ...
                            <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-2 d-block">
                                <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-24.jpg" alt="...">
                            </a>
